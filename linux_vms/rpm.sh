...
install_kds() {{
  ...
  ARCH=$(uname -m)
  case "$ARCH" in
    x86_64)          KDS_RPM_URL="https://kasmweb-build-artifacts.s3.amazonaws.com/kasm_desktop_service/8e3b288d3732c758aa49b01dbf33e5ad864f3d02/kasm-desktop-service_1.8_amd64.rpm" ;;
    aarch64|arm64)   KDS_RPM_URL="https://kasmweb-build-artifacts.s3.amazonaws.com/kasm_desktop_service/8e3b288d3732c758aa49b01dbf33e5ad864f3d02/kasm-desktop-service_1.8_arm64.rpm" ;;
