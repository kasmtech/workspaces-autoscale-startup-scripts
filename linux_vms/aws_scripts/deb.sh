...
ENABLE_AD_JOIN=0
AD_DOMAIN="{domain}"
AD_JOIN_PASSWORD="{ad_join_credential}"
AD_DNS_SERVER=""
SET_DOMAIN_FQDN=1
...
ARCH=$(uname -m)
case "$OS_CODENAME" in
jammy)    KASMVNC_DISTRO="jammy" ;;
noble)    KASMVNC_DISTRO="noble" ;;
bullseye) KASMVNC_DISTRO="bullseye" ;;
bookworm) KASMVNC_DISTRO="bookworm" ;;
*)
